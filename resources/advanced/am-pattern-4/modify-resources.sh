...
sed -i '/volumes:/a \      - name: wso2am-conf-entrypoint\n        configMap:\n          name: {{ template "am-pattern-4.resource.prefix" . }}-am-gateway-entrypoint\n          defaultMode: 0777' $k8s_repo_dir/advanced/am-pattern-4/templates/am/gateway/wso2am-pattern-4-am-gateway-deployment.yaml
...
sed -i '/volumes:/a \        - name: wso2am-conf-entrypoint-tm\n          configMap:\n            name: {{ template "am-pattern-4.resource.prefix" . }}-am-trafficmanager-entrypoint\n            defaultMode: 0777' $k8s_repo_dir/advanced/am-pattern-4/templates/am/traffic-manager/instance-1/wso2am-pattern-4-am-trafficmanager-deployment.yaml
...
sed -i '/volumes:/a \        - name: wso2am-conf-entrypoint-tm\n          configMap:\n            name: {{ template "am-pattern-4.resource.prefix" . }}-am-trafficmanager-entrypoint\n            defaultMode: 0777' $k8s_repo_dir/advanced/am-pattern-4/templates/am/traffic-manager/instance-2/wso2am-pattern-4-am-trafficmanager-deployment.yaml


# add volume entry to cp deployment
sed -i '/volumes:/a \        - name: wso2am-conf-entrypoint\n          configMap:\n            name: {{ template "am-pattern-4.resource.prefix" . }}-am-cp-entrypoint\n            defaultMode: 0777' $k8s_repo_dir/advanced/am-pattern-4/templates/am/control-plane/instance-1/wso2am-pattern-4-am-control-plane-deployment.yaml
sed -i '/volumes:/a \        - name: wso2am-conf-entrypoint\n          configMap:\n            name: {{ template "am-pattern-4.resource.prefix" . }}-am-cp-entrypoint\n            defaultMode: 0777' $k8s_repo_dir/advanced/am-pattern-4/templates/am/control-plane/instance-2/wso2am-pattern-4-am-control-plane-deployment.yaml
